...
export const translations = {  
  es: {
    ...
    homeThanks: "El desarrollo de los juegos de WoAiDa ha sido posible gracias a estas tres personas, claves para todo el trabajo realizado aquí.",
  ...
  en: {
    ...
    homeThanks: "The development of the WoAiDa games has been made possible thanks to these three people, who were key to all the work done here.",
    homeGames: "Our games",
