    ...
    <div className={styles.gbPage}>
      <section className={`${styles.hero} text-center text-white py-5 mb-5`}>
        <div className="container">
          ...
          <p className="lead mb-0 mx-auto" style={{ maxWidth: 700 }}>
            Cómo se gestionan los datos utilizados por WoAiDa Interactive.
          </p>
        </div>
      </section>
      ...
      <div className="container mb-5">
        <div className={`${styles.card} p-5 rounded-4 shadow-sm`}>
          ...
          <p>
            Si deseas solicitar la modificación o eliminación de una puntuación,
            puedes contactar mediante el correo electrónico indicado en este
            sitio web.
          </p>
